...
namespace StadiumTicketBooking.Forms
{
    partial class frmDangNhapKhachHang
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblMoTa.Size = new Size(303, 46);
            lblMoTa.TabIndex = 1;
            lblMoTa.Text = "Đăng nhập để đặt vé, xem hóa đơn,\r\nquản lý tài khoản và thông tin cá nhân.";
            // 
            // lblHeThong
            // 
            ...
            panelRight.Controls.Add(btnMoDangKy);
            panelRight.Controls.Add(lnkQuenMatKhau);
            ...
            // btnMoDangKy
            // 
            btnMoDangKy.BackColor = Color.White;
            btnMoDangKy.FlatStyle = FlatStyle.Flat;
            btnMoDangKy.Font = new Font("Segoe UI", 10F, FontStyle.Bold);
            btnMoDangKy.ForeColor = Color.FromArgb(30, 41, 59);
            btnMoDangKy.Location = new Point(82, 564);
            btnMoDangKy.Name = "btnMoDangKy";
            btnMoDangKy.Size = new Size(332, 48);
            btnMoDangKy.TabIndex = 6;
            btnMoDangKy.Text = "Đăng ký tài khoản";
            btnMoDangKy.UseVisualStyleBackColor = false;
            btnMoDangKy.Click += btnMoDangKy_Click;
            // 
            // lnkQuenMatKhau
            // 
            lnkQuenMatKhau.AutoSize = true;
            lnkQuenMatKhau.Font = new Font("Segoe UI", 9.5F, FontStyle.Regular, GraphicsUnit.Point);
            lnkQuenMatKhau.LinkColor = Color.FromArgb(37, 99, 235);
            lnkQuenMatKhau.Location = new Point(286, 434);
            lnkQuenMatKhau.Name = "lnkQuenMatKhau";
            lnkQuenMatKhau.Size = new Size(127, 21);
            lnkQuenMatKhau.TabIndex = 5;
            ...
            lblDangNhap.Size = new Size(294, 41);
            lblDangNhap.TabIndex = 0;
            lblDangNhap.Text = "Đăng nhập khách hàng";
            // 
            ...
            MaximizeBox = false;
            Name = "frmDangNhapKhachHang";
            StartPosition = FormStartPosition.CenterScreen;
            Text = "Đăng nhập khách hàng";
            Load += frmDangNhapKhachHang_Load;
